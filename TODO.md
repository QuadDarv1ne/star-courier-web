...
|-------|--------|-----------|
| `main` | ✅ Ожидает слияния | Auth + Leaderboard API + тесты |
| `dev` | ✅ В работе | auth.py, leaderboard.py, тесты API |
...
- [ ] Рефакторинг остальных API endpoints (inventory.py, combat.py)
